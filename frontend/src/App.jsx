...
export default function App(){
  ...
  return(
    <div style={{maxWidth:"480px",margin:"0 auto",minHeight:"100vh",background:dm.bg,fontFamily:"'Segoe UI',sans-serif",color:dm.text,paddingBottom:"80px",fontSize:`${14*fs}px`,transition:"all 0.3s"}}>
